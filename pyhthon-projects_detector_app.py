...
class Ui_Detector(object):
    def setupUi(self, Detector):
        ...
        self.FreqBox.setGeometry(QtCore.QRect(300, 550, 122, 30))
        self.FreqBox.setObjectName("FreqSelect")
        ...
        self.FreqBox.activated.connect(self.freq_selector)
        self.menuSave.setDisabled(True)
        self.menuInput.setDisabled(False)
    ...
    def freq_selector(self):
        """
        Function to change frequency setting

        """
        if self.FreqBox.currentText() == "60Hz":
            self.main_code(self.file)

        elif self.FreqBox.currentText() == "50Hz":
            self.main_code(self.file)
    ...
    def main_code(self, file):
        ...
        if len(contours) != 0:
            ...
            # Condition for frequency at 50Hz
            if self.FreqBox.currentText() == "50Hz":
            ...
            # Condition for frequency at 60Hz
            elif self.FreqBox.currentText() == "60Hz":
                if 40 > y > 20:
                    # draw the biggest contour (c) in red
                    cv2.rectangle(output, (x, y), (x + w, y + h), (0, 0, 255), 1)
                else:
    ...
    def retranslateUi(self, Detector):
        ...
        self.FreqBox.setItemText(0, _translate("Detector", "50Hz"))
        self.FreqBox.setItemText(1, _translate("Detector", "60Hz"))
